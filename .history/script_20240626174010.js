...
let songs = [
    ...
    {songname: "Nahi Jeena - Salam-e-ishq", filepath: "Files/songs/9.mp3", coverpath: "Files/covers/8.jpg"},
    {songname: "Man Kare Toh - Salam-e-ishq", filepath: "Files/songs/10.mp3", coverpath: "Files/covers/8.jpg"}
]
...
Array.from(document.getElementsByClassName("songitemplay")).forEach((element)=>{
    element.addEventListener("click", (e)=>{
        if(audioelement.paused || e.target.classList.contains("fa-circle-play")){
            makeallplay()
...
document.getElementById('next').addEventListener("click",()=>{
    ...
    document.getElementById('next').style.color = "lightblue"
    setTimeout(() => {
...
document.getElementById('previous').addEventListener("click",()=>{
    ...
    document.getElementById('previous').style.color = "lightblue"
    setTimeout(() => {
        document.getElementById('previous').style.color = ""
    }, 300);
